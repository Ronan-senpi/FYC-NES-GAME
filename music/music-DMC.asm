...
- BIT PPUSTATUS ; On attend une dernière fois
  ...
  ; A : 0 pour PAL, autre chose pour NTSC
	ldx #<Bonetrousle_simplified_music_data ; premier pointeur vers la musique stocké dans X
	ldy #>Bonetrousle_simplified_music_data ; deuxième pointeur vers la musique stocké dans Y
...
.include "Bonetrousle-simplified.asm";morceau converti de .txt (FamiTracker) en .asm avec le tool 'text2data' de Famitone2
.incbin  "Bonetrousle-simplified.dmc";samples pour le DMC
